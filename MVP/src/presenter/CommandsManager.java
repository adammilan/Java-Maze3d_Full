...
public class CommandsManager {
	...
	public HashMap<String, Command> getCommandsMap() {
		...
		commands.put("properties_msg", new PropertiesMSG());

		return commands;
	}

	public class PropertiesMSG implements Command {

		@Override
		public void doCommand(String[] arg0) {
			Properties properties = PropertiesLoader.getInstance().getProperties();
			view.displayMessage("Properties has been Initial");
	...
	class MazeSolutionIsReady implements Command {
		...
		public void doCommand(String[] args) {
			...
			// model.modelGetSolution(name);
			// view.display_solution(model.modelGetSolution(name));
